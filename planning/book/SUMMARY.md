...
This book is the working planning document for the Beale rewrite.

## Chapter 1: Product Direction

- [Product Scope](product-scope.md)
- [Authorization Model](authorization-model.md)
- [First Release Mode](first-release-mode.md)
- [Vulnerability Domains](vulnerability-domains.md)
- [Planning Decisions](../research/open-questions.md)

## Chapter 2: Harness Architecture
...
## Chapter 3: Data, Evidence, and Verification

- [Persistence Model](persistence-model.md)
- [SQLite Schema](sqlite-schema.md)
- [Trace and Evidence Provenance](trace-evidence-provenance.md)
...
## Chapter 5: Evaluation and Research

- [Experiment Design](experiment-design.md)
- [Research Synthesis](../research/harness-findings.md)
- [Source Index](../research/source-index.md)
