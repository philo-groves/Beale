...
- [x] Supply tiered memory identity and same-subject peer database references so Honeycrisp can distinguish session, workspace, and owner/subject knowledge without expanding its tool set.
