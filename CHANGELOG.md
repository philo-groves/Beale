...
- The workspace dashboard now uses Overview, Activity, Resources, Memory, Runbooks, and Utilities tabs in a left-aligned, bounded layout. Overview persists editable workspace metadata in place when a field loses focus; Memory and Runbooks reuse their detailed catalog rows and open the right detail panel only after a selection, while Utilities presents Settings-style Dejunk and Dream actions with live counts and progress states.
